...
export interface ApiClassListClassList extends Schema.SingleType {
  ...
  info: {
    singularName: 'class-list'
    pluralName: 'class-lists'
  ...
  attributes: {
    cards: Attribute.Component<'dynamic.carousel'>
...
export interface ApiCoachListCoachList extends Schema.SingleType {
  collectionName: 'coaches_list'
  info: {
    singularName: 'coach-list'
    pluralName: 'coaches-list'
    displayName: 'Coach List'
  }
  options: {
    draftAndPublish: true
  }
...
export interface ApiCustomPageCustomPage extends Schema.CollectionType {
  ...
  attributes: {
    hero: Attribute.Relation<
      ...
      'api::hero.hero'
    >
    dynamicComponents: Attribute.DynamicZone<
      [
        'dynamic.carousel',
        'dynamic.social',
        'dynamic.faqs',
    ...
    >
    name: Attribute.String
    slug: Attribute.UID<'api::custom-page.custom-page', 'name'>
    createdAt: Attribute.DateTime
    updatedAt: Attribute.DateTime
    publishedAt: Attribute.DateTime
    createdBy: Attribute.Relation<
...
export interface ApiGraduateListGraduateList extends Schema.SingleType {
  ...
  info: {
    singularName: 'graduate-list'
    pluralName: 'graduates-list'
    displayName: 'Graduate List'
    description: ''
  }
  options: {
    draftAndPublish: true
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime
    createdBy: Attribute.Relation<
      'api::graduate-list.graduate-list',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private
...
export interface ApiTimetableTimetable extends Schema.SingleType {
  ...
  attributes: {
    ...
    Esher: Attribute.Component<'basic.day', true>
    createdAt: Attribute.DateTime
    updatedAt: Attribute.DateTime
    publishedAt: Attribute.DateTime
    createdBy: Attribute.Relation<
